var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hands." class="svelte-1ghtied"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0 = element("div");
    			span = element("span");
    			attr(span, "class", "sr-olny");
    			attr(div0, "class", "progress-bar svelte-1y80lw0");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-1y80lw0");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    <a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Source</a>`;
    			...
    			attr(h1, "class", "svelte-1mdh1he");
    			attr(h3, "class", "svelte-1mdh1he");
    		},
    		m(target, anchor) {
